            ...
            <main>
                ...
                <form action="" className="flex flex-col">
                    <div className="relative my-6">
                        ...
                        <input type="email" className="block w-72 py-0.5 px-4 text-sm bg-transparent border-0 border-b-2 border-gray-400 appearance-none focus:border-blue-400 outline-none" placeholder="Your Username"/>
